...
<?php
            ...
            $id = $_GET['userid'];
            $selectquery = "select * from delivery where userid='$id'";
            ...
            $updatequery = "update delivery set userid=$id, name='$name', username='$username', email='$email', phone='$phone', address='$address'   where userid=$id";
