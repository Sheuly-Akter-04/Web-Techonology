...
<br>
<br>
<form method="post" action="../Project new/controller/adminlogincheck.php" onsubmit="return validate()">
<fieldset>

    <legend style="font-family: Arial, Helvetica, sans-serif;"><b>ADMIN LOGIN</b></legend>
